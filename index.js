...
const welcomeText = (u) => {
  ...
  return (
`<b>👋 Привет, я Павел — твой персональный тренер!</b>

Я собираю для тебя план, считаю ${kcal}, даю чёткие задания и пинаю, когда надо.
Основа — ВОЗ/ACSM и лучшие практики тренинга и питания. Ты тренируешься — я думаю за тебя.
