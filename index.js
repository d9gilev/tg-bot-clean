...
// Главное меню (ReplyKeyboard) - упрощённое
const mainKb = {
  keyboard: [
...
// /start - теперь обрабатывается в модуле анкеты

// /menu — быстрый способ вернуть клавиатуру, если её сняли
...
// Обработка сообщений теперь полностью в модуле анкеты

// Обработка отчётов теперь в модуле анкеты
